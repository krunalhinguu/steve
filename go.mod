...
replace (
	github.com/rancher/apiserver => github.com/krunalhinguu/apiserver v1.29.0-rancher1
	github.com/rancher/dynamiclistener => github.com/krunalhinguu/dynamiclistener v1.29.0-rancher1
	github.com/rancher/norman => github.com/krunalhinguu/norman v1.29.0-rancher1
